 ...
 * @param props.bannerUrl - Imagem de fundo do banner. Ainda não existe coluna equivalente no banco (mantido como mock).
 * @param props.avatarUrl - Foto de perfil/logo. Para usuário vem de `User.avatar` (existe no banco); para empresa é mock.
 * @param props.name - Nome exibido abaixo da foto de perfil.
 * @param props.subtitle - Texto complementar (ex.: profissão, cidade, site).
 * @param props.actions - Ações do cabeçalho do perfil (ex.: editar, entrar em contato).
 * @param props.children - Conteúdo específico do perfil (renderizado dentro do `WrapperLayout`).
 *
 * @returns O template de perfil renderizado.
 */
