...
const professionalMockData = [
    {
        ...
        registrations: [
            { profession: "Engenheiro Eletricista", council: "CREA-MG", number: "123456", expirationDate: "2027-03-01" },
        ],
    },
    {
        id: "professional-2",
        ...
        registrations: [
            { profession: "Técnica em Eletrotécnica", council: "CREA-PR", number: "654321", expirationDate: "2026-11-15" },
        ],
    },
    {
        id: "professional-3",
        ...
        registrations: [
            { profession: "Engenheiro Eletricista", council: "CREA-PE", number: "789456", expirationDate: "2028-06-30" },
        ],
    },
] as Professional[];
