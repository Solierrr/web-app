...
function Trigger() {
  ...
  return <button onClick={() => contextMenu.open([{ label: "Editar", onClick: vi.fn() }], 30, 40)}>abrir</button>;
}

describe("ContextMenuProvider", () => {
  it("throws when useContextMenu is used outside the provider", () => {
    expect(() => renderHook(() => useContextMenu())).toThrow("useContextMenu: deve ser usado dentro de um ContextMenuProvider.");
  });
