...
describe('MenuItem', () => {
  it('calls onSelect when clicked', () => {
    ...
    render(
      <MenuList role="menu">
        <MenuItem role="menuitem" onSelect={handleSelect}>Item</MenuItem>
      </MenuList>,
    )
  ...
  it('does not call onSelect when disabled, and applies aria-disabled', () => {
    ...
    render(
      <MenuList role="menu">
        <MenuItem role="menuitem" onSelect={handleSelect} disabled>Item</MenuItem>
      </MenuList>,
    )
  ...
  it('calls a caller-provided onKeyDown alongside its own activation logic', () => {
    ...
    render(
      <MenuList role="menu">
        <MenuItem role="menuitem" onSelect={handleSelect} onKeyDown={handleKeyDown}>Item</MenuItem>
      </MenuList>,
    )
  ...
  it('sets aria-selected only when selected is explicitly passed', () => {
    render(
      <MenuList role="listbox">
        ...
        <MenuItem role="option" selected={false}>Não selecionado</MenuItem>
        <MenuItem role="option" selected={true}>Selecionado</MenuItem>
      </MenuList>,
    )
